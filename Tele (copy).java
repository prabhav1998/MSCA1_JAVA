...
class TeleGUI extends JFrame implements ActionListener
{
    ...
    TeleGUI()
    {
        try 
        {
            ...
            insert.setBounds(8,90,100,60);
            search = new JButton("Search");
            search.setBounds(130,90,100,60);
            delete = new JButton("Delete");
            delete.setBounds(255,90,100,60);
            display = new JButton("Display");
            display.setBounds(380,90,100,60);
            exit = new JButton("Exit");            
			exit.setBounds(505,90,100,60);
    ...
    public void actionPerformed(ActionEvent Ae)
	{
        ...
        else if(Ae.getSource() == search)
        {
            try 
            {
                ...
                String searchQury = "select * from tele where teleNo=? and name=? and address=?";
